...
* A easy link to the veterans league table and fixtures.
...
Opponents will use the "how to find us map" to get directions on how to get to the ground, they will also contact managment via the contact us page.

### Fans
Fans can see how players are performing via the team page and match report page, they can also be kept up to date on fixtures and leauge tables.
